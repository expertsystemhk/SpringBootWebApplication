package SpringBootWebApplication;
...
import SpringBootWebApplication.controller.WelcomeController;
...
public class SpringBootWebApplicationTest {
    ...
    public void main() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("PKS demo")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Hello, PKS demo")));
